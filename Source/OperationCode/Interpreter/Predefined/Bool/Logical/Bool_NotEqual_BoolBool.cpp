...
#include "Bool_NotEqual_BoolBool.h"
#include "Interpreter/CodeRunner/Values/PredefinedClasses/BoolInstance.h"


UBool_NotEqual_BoolBool::UBool_NotEqual_BoolBool()
{
...
UValue* UBool_NotEqual_BoolBool::Run_Implementation(USimpleFunctionDefinitionRTS* RTS)
{
	...
	FString NotEqualString = lhs != rhs ? "true" : "false";
	RTS->AddDebugMessage("Lhs is " + lhsString + ", rhs is " + rhsString + ".");
	RTS->AddDebugMessage("Returning " + NotEqualString + ".");
