...
#include "SAP_Literal.generated.h"

/**
 * 
 */
UCLASS()
class OPERATIONCODE_API USAP_Literal : public USemanticAnalysisPhase
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY()
	UAST_ClassDefinition* Owner;
	UAST_ClassDefinition* Caller;
